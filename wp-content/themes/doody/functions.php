...
function doody_scripts() {
    // load bootstrap css
    wp_enqueue_style( 'doody-bootstrap-css', get_template_directory_uri() . '/assets/css/flatly.css');

    //load hovercss
    wp_enqueue_style( 'doody-hovercss', get_template_directory_uri() . '/assets/css/hover-min.css');

    //load fonts
    wp_enqueue_style('doody-arbutusslab-opensans-font', 'https://fonts.googleapis.com/css?family=Arbutus+Slab');
