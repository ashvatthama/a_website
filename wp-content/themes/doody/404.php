    ...
    <main id="main" class="site-main card shadow-sm module-border-wrap">
        <section class="error-404 not-found card-body">
            ...
            <div class="page-content">
				...
				$doody_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'doody' ), convert_smilies( ':)' ) ) . '</p>';
				the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$doody_archive_content" );
